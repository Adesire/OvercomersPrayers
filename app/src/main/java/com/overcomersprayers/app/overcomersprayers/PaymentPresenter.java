...
public class PaymentPresenter {
    ...
    public PaymentPresenter(AppCompatActivity context, Transactions transactions, Listerners.PaymentListener paymentListener) {
    ...
    public void addPrayerToUserPrayer() {
        ...
        reference.child("userprayer").child(user.getUid()).child(transactions.getPrayerId()).setValue(true).addOnCompleteListener(task -> endTransaction(true));
    }
